...
Generated index of every spec folder. Do not edit by hand; the write-spec and
design-spec skills regenerate it. Shape: `docs/process/spec-convention.md`.
...
| [Give the storefront a dark, modern gothic redesign](storefront-gothic-redesign/requirements.md) | `proposed` | #11 |
