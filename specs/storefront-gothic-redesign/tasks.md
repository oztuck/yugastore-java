...
- [x] 9. Regression-check add-to-cart from a restyled product card still works end-to-end with no logic changes (WHEN a shopper adds an item to the cart from a redesigned product card)
